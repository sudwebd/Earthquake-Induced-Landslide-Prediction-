...
ds_in = drv.Open("/home/btpbatch3/Downloads/shp_files/tohoku_Wartman_and_others_2013/Wartman_and_others_2013_polygons.shp")    #Get the contents of the shape file
...
def check(lon, lat):
    ...
    if len(lyr_in)>0:
        try:
            if(arr[p][q]!=-9999):
                print(loni, lati, slope_arr[offy_slope][offx_slope], arr[p][q], vegi_arr[vegioffy_slope][vegioffx_slope],  'YES')
        except:
            pass
        ...
        try:
            if(arr[p][q]!=-9999):
                print(loni, lati, slope_arr[offy_slope][offx_slope], arr[p][q], vegi_arr[vegioffy_slope][vegioffx_slope], 'NO')
        except:
            pass
            # print(loni, lati, slope_arr[offy_slope][offx_slope], arr[p][q], vegi_arr[vegioffy_slope][vegioffx_slope], "NULL")  
...
# xMin,yMin 140.054,35.7694 : xMax,yMax 142.058,39.9788
gap_distance=250
...
[xMin,yMin,z]=geo_to_jgd_ctran.TransformPoint(140.054,35.7694)
[xMax,yMax,z]=geo_to_jgd_ctran.TransformPoint(142.058,39.9788)
